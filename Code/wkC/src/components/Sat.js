...
import { ScrollView,View,Image,Text,TouchableHightLight,Modal,TextInput,Dimensions,TouchableOpacity   } from 'react-native';
import { Tile, List, Icon,Button } from 'react-native-elements';
 ...
 //<FadeInView duration={550} style={{ alignItems: 'center' }}onFadeComplete={() => alert('遲到嘍！子榮')}></FadeInView> 
// Make a component
